...
//                        'ks_allow_parent_task': each_project_task.ks_allow_subtask,
    ...
    ks_left_grid_columns: function () {
      ...
      if (this.ks_gantt_arch && this.ks_gantt_arch.planned_hours) {
        ...
        if (this.ks_gantt_arch && this.ks_gantt_arch.ks_task_end_date) {
          ks_gantt_config_columns.push({
              name: "end_date",
              align: "center",
              label: _t("End Time"),
        ...
        if (this.ks_gantt_arch && this.ks_gantt_arch.ks_task_deadline) {
          ks_gantt_config_columns.push({
              name: "deadline",
              align: "center",
              label: _t("Deadline"),
              ...
              width: 130,
              template: function (task) {
                if (task.ks_deadline_tooltip) {
                  return gantt.ks_gantt_view_datetime_format(task.ks_deadline_tooltip);
                }
                return "";
              },
            });
